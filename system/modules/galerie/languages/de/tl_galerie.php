...
$GLOBALS['TL_LANG']['tl_galerie']['published']['1'] = "Die Galerie auf der Webseite sichtbar machen.";
$GLOBALS['TL_LANG']['tl_galerie']['themesSRC']['0'] = "Themes";
$GLOBALS['TL_LANG']['tl_galerie']['themesSRC']['1'] = "Bitte wählen Sie ine Theme für die Galerie aus. Der Pfad ist tl_files/galleria/themes/).";
...
$GLOBALS['TL_LANG']['tl_galerie']['initialTransition']['1'] = "Definiert einen Übergangseffekt, der für das erste Bild benutzt wird. Beispielsweise kann man in der gesamten Galerie Slide-Effekte nutzen, das erste Bild aber einfaden. Der zu setzende Wert ist dann 'fade'.";
...
$GLOBALS['TL_LANG']['tl_galerie']['showInfo']['1'] = "Auf 'false' setzen wenn die cation nicht angezeugt werden soll.";
...
$GLOBALS['TL_LANG']['tl_galerie']['lightbox']['1'] = "Diese Option ist eine Hilfsfunktion um eine Lightbox zu ermöglichen. Wenn für das Bild ein Link definiert wurde hat das Vorrang vor dieser Einstellung.";
...
$GLOBALS['TL_LANG']['tl_galerie']['imageCrop']['1'] = "Definert wie das Bild innerhalb des Containers beschnitten wird.<br />\n'Ja' bedeutet dass alle Bilder die Bühne ausfüllen, zentriert und beschnitten werden.<br/>\n'Nein' bedeutet, dass die Bilder so akliert werden dass sie in die Bühne passen.<br />\n'Höhe' skaliert die Bilder so dass sie die Höhe der Bühne ausfüllen.<br />\n'Breite' skaliert die Bilder so dass sie die Breite der Bühne ausfüllen.";
...
$GLOBALS['TL_LANG']['tl_galerie']['imagePan']['1'] = "Galleria besitzt einen eingebauten Verschiebeeffekt. Dieser Effekt ist nützlich wenn Bilder beschnitten werden, die Nutzer aber trotzdem die ganzen Bilder sehen sollen können. Ein setzen auf 'true' gibt die Möglichkeit, mittels einer Mausbewegung verborgene Bildteile anzuzeigen. dieser Effelt ist beispielsweise nützlich um freie Bereich nach Bildskalierung zu vermeiden und dabei trotzdem den gesamten Bildinhalt für den Nutzer zugänglich zu machen. Wenn der Effekt zu langsam dargestellt wird können Feineinstellungen im Bereich 'Sanftheit des Verschiebeeffektes' vorgenommen werden.";
...
$GLOBALS['TL_LANG']['tl_galerie']['dummy']['1'] = "Diese Option ermöglicht es, ein Standardbild festzulegen, das angezeigt wird, wenn Galleria das eigentlich vorgesehene Bild nciht finden kann. Wie eine #404-Fehlerseite für Galleria ... ;-)";
